...
describe("handleCheckboxChange -  Number of checkboxes selected", () => {
  ...
  it("One checkbox selected", () => {
    ...
    checkbox1.simulate("change", { target: { handleCheckBoxChange: true } });
  ...
  it("Two checkbox selected", () => {
    ...
    checkbox2.simulate("change", { target: { handleCheckBoxChange: true } });
  ...
  it("Three checkbox selected", () => {
    ...
    checkbox3.simulate("change", { target: { handleCheckBoxChange: true } });
  ...
  it("One checkbox unselected", () => {
    const component = mount(<App />);
    const checkbox2 = component.find({ value: "Two" });
    checkbox2.simulate("change", { target: { handleCheckBoxChange: false } });
    expect(component.state().numberOfCheckboxes).toEqual(1);
  });
});
