...
describe("handleCheckboxChange -  Number of checkboxes selected", () => {
  ...
  it("One checkbox selected", () => {
    ...
    checkbox1.simulate("change", { target: { checkboxesChecked: 1 } });
  ...
  it("Two checkbox selected", () => {
    ...
    checkbox2.simulate("change", { target: { checkboxesChecked: 2 } });
  ...
  it("Three checkbox selected", () => {
    ...
    checkbox3.simulate("change", { target: { checkboxesChecked: 3 } });
