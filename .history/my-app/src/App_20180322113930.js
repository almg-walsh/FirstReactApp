  ...
  toggleCheckbox = checkbox => {
    ...
    this.selectedCheckboxes.has(checkbox) ? 
      ...
      if (this.selectedCheckboxes.size === 1){
        ...
        this.toggleStyleChange(this.state.classNames);
      } else if (this.selectedCheckboxes.size === 2){
      listClassNames.add(styles.backgroundBorder);
        this.setState({
          classNames: listClassNames
        })
        this.toggleStyleChange(listClassNames);
      }
      
  }

  toggleStyleChange = style => {
    if (this.state.classNames.has(style)) {

      console.log(this.state.classNames)
      this.state.classNames.delete(style)
