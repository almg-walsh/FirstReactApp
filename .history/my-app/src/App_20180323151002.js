...
class App extends Component {
  ...
  toggleCheckbox = (label, state) => {
    if (this.selectedCheckboxes.has(label) && this.selectedCheckboxes.size > 1){
      ...
      if (this.selectedCheckboxes.size === 1){
        this.setState(prevState => ({
          classNames: prevState.classNames.concat(styles.border)
        }));
        console.log(this.state.classNames)

      } else if (this.selectedCheckboxes.size === 2){
        this.setState(prevState => ({
          classNames: prevState.classNames.concat(styles.backgroundBorder)
        }));
      }  
